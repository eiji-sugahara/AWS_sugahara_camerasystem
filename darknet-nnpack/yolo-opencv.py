...
while True:
    if (os.path.isfile('/workspace/host/opencv/photo.jpg')):
        os.system("./darknet detector test cfg/obj.data cfg/yolov3-tiny_obj2.cfg yolov3-tiny_obj2_last.weights  /workspace/host/opencv/photo.jpg")
        new_path = shutil.move('/workspace/host/darknet-nnpack/predictions.jpg', '/workspace/host/photo.jpg')
        #print("Uploading")
        #photo_up()
        #print("DONE")
        os.remove('/workspace/host/opencv/photo.jpg')